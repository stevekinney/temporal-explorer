...
export const mappingEvidenceSchema = z
  .object({
    kind: z.union([
      ...
      z.literal('update-name'),
      z.literal('child-workflow-type'),
      z.literal('external-signal-name'),
      z.literal('patch-id'),
      z.literal('continue-as-new'),
      z.literal('scope-containment'),
      z.literal('dynamic-dispatch'),
      z.literal('replay-command-sequence'),
